                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" name="doctor" style="height: 55px;">
                                        ...
                                        <option value="Rajarshi Mitra">Dr Shiwang Sharma</option>
                                        <option value="Sanjeev Kumar">sant Kumar Yadav</option>
                                        <option value="Soumya Ghosh">Kiran pawar</option>
                                        <option value="Samir Ray">Sachin yadav</option>
